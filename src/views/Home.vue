  ...
  <div>
    <header class="home-header wrap" :class="{'active' : headerScroll}">
      ...
      <div class="header-search">
        <span class="app-name">农产品商城</span>
  ...
  setup() {
    ...
    const state = reactive({
      ...
      categoryList: [
        {
          name: '农产知识',
          imgUrl: 'https://i.postimg.cc/kMY8fN34/image.png',
          categoryId: 100001
        }, {
          name: '防害病虫',
          imgUrl: 'https://i.postimg.cc/NFsjFgzg/11837449.png',
          categoryId: 100003
        }, {
          name: '农产到家',
          ...
          name: '娱乐休闲',
          imgUrl: 'https://i.postimg.cc/9Md2zYdB/image.png',
          categoryId: 100005
        }, {
          name: '充值缴费',
